        ...
        return (
            <div className={classes.wrap}>
                <div>
                    ...
                    />
                    {this.state.images.length > 0 ? (<div><DisplayingPictures images={this.state.images}/>
                            <button className={classes.btn} onClick={() => this.onAmountAdd(this.state.amount)}>More
                            </button>
                            {this.state.amount > 9 &&<button className={classes.btn} onClick={() => this.onAmountDel(this.state.amount)}>Less</button> }
